...
target = """                  <div className="w-full flex justify-center gap-4">
...
replacement = """                  <button onClick={() => setActiveModal("deposit")} className="bg-[#F3F0FF] rounded-[20px] h-[72px] basis-[48%] flex-grow max-w-[49%] flex flex-col items-center justify-center active:opacity-80 transition-opacity">
                    <div className="flex items-center gap-2">
                       <ArrowRightCircle size={24} className="text-[#7B61FF]" style={{ strokeWidth: 1.5 }} />
                       <span className="text-[#1E1F24] text-[13px] font-medium leading-[1.2]">Recharge</span>
                    </div>
...
if target in content:
    ...
    print("Reverted Home screen buttons")
else:
    print("Target not found in Home screen")
