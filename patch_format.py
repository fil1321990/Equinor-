...
target1 = '''                                  Total income: ₦{totalIncome.toLocaleString()}'''
replacement1 = '''                                  Total income: ₦{totalIncome.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}'''
